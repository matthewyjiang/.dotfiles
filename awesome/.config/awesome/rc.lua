...
local playerctl_widget = require("awesomewm-playerctl.playerctl") {
    play_icon = "/home/emgym/.config/awesome/awesomewm-playerctl/player_pause.png",
    pause_icon = "/home/emgym/.config/awesome/awesomewm-playerctl/player_play.png",
    show_tooltip = false,
...
-- If you do not like this or do not Eehave such a key,
...
mylauncher:connect_signal("button::press", function()
    awful.spawn(
        "rofi -show power-menu -modi power-menu:rofi-power-menu -theme ~/.config/rofi/powermenu/type-1/style-1.rasi")
end)
...
mytextclock.font = "Noto Sans Mono, Medium 11"

local clock_widget = wibox.container.margin(mytextclock, 7, 15, 5, 5)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.textbox_container = wibox.container.margin(textbox, 10, 0, 0, 0)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 30, bg = beautiful.bg_normal .. 80 })
    s.systray = wibox.widget.systray()
    s.systray.set_horizontal(true)

    s.systray_container = wibox.container.margin(s.systray, 0, 0, 0, 0)
    ...
    s.mybottomwibox = awful.wibar({ position = "bottom", screen = s, height = 30, bg = beautiful.bg_normal .. 80 })
...
globalkeys = gears.table.join(
    ...
    -- Prompt
    awful.key({ modkey }, "r",
        function() awful.util.spawn('rofi -show drun -theme ~/.config/rofi/launchers/type-2/style-1.rasi') end,
    ...
    awful.key({ modkey }, "e", function() awful.spawn.spawn(terminal .. " -e yazi") end,
